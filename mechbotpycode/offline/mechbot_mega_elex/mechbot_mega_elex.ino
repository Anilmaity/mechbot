...
long int B_position_error[2] = {0,0};
long int Brake_Speed = 0;
long int B_Current_position_B[2] = {0,0};
long int B_Current_position_A[2] = {0,0};
long int Current_brake_position[2] = {0,0};
...
// throttle
int initial_throttle = 36; //0.7 volt
int max_limit = 147; //
